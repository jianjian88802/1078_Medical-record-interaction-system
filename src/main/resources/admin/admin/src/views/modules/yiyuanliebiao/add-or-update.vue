<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="负责人手机" prop="fuzerenshouji">
          <el-input v-model="ruleForm.fuzerenshouji" 
              placeholder="负责人手机" clearable  :readonly="ro.fuzerenshouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="负责人手机" prop="fuzerenshouji">
              <el-input v-model="ruleForm.fuzerenshouji" 
                placeholder="负责人手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="负责人身份证" prop="fuzerenshenfenzheng">
          <el-input v-model="ruleForm.fuzerenshenfenzheng" 
              placeholder="负责人身份证" clearable  :readonly="ro.fuzerenshenfenzheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="负责人身份证" prop="fuzerenshenfenzheng">
              <el-input v-model="ruleForm.fuzerenshenfenzheng" 
                placeholder="负责人身份证" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuzeren = true;
          ...
          if(o=='fuzerenshouji'){
            this.ruleForm.fuzerenshouji = obj[o];
	    this.ro.fuzerenshouji = true;
            continue;
          }
          if(o=='youxiang'){
	    ...
	    this.ro.youxiang = true;
          ...
          if(o=='fuzerenshenfenzheng'){
            this.ruleForm.fuzerenshenfenzheng = obj[o];
	    this.ro.fuzerenshenfenzheng = true;
            continue;
          }
          if(o=='zhanghao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yiyuanliebiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yiyuanliebiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
