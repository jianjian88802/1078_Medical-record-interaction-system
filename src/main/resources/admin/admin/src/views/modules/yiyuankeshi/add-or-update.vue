      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.keshitupian" label="科室图片" prop="keshitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.keshitupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="科室人员" prop="keshirenyuan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="科室人员"
                  v-model="ruleForm.keshirenyuan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.keshirenyuan" label="科室人员" prop="keshirenyuan">
                    <span>{{ruleForm.keshirenyuan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshijianjie = true;
          ...
          if(o=='keshirenyuan'){
            this.ruleForm.keshirenyuan = obj[o];
	    this.ro.keshirenyuan = true;
            continue;
          }
          if(o=='keshitupian'){
	...
	this.ruleForm.keshijianjie = this.ruleForm.keshijianjie.replace(reg,'../../../springbootr2r43/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yiyuankeshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yiyuankeshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
